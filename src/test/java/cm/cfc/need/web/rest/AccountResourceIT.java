...
import cm.cfc.need.IntegrationTest;
import cm.cfc.need.config.Constants;
import cm.cfc.need.domain.User;
import cm.cfc.need.repository.AuthorityRepository;
...
import cm.cfc.need.service.dto.PasswordChangeDTO;
import cm.cfc.need.web.rest.vm.KeyAndPasswordVM;
import cm.cfc.need.web.rest.vm.ManagedUserVM;
